...
export const whatIsPosBlog: SingleBlogData = {
  ...
  tocItems: [
    ...
    { title: "How to use a POS system", href: "#how-to-use-a-pos-system" },
    { title: "POS system vs cash register", href: "#pos-system-vs-cash-register" },
    { title: "How to choose a POS system", href: "#how-to-choose-a-pos-system" },
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "A POS system combines software and compatible hardware to record sales, accept payments, issue receipts and manage information such as products, stock and customers.",
    },
    {
    ...
    },
    {
      ...
      answer: "A multi-branch POS system can combine sales and stock information from several locations, but the available controls and limits depend on the selected provider and plan.",
    },
    {
      question: "Is a POS system the same as a cash register?",
      answer: "No. A cash register mainly records payments and stores cash. A modern POS system can also connect sales with inventory, customer records, purchasing, user permissions and reporting.",
    },
  ],
  contentHtml: `
    ...
    <p>POS means point of sale. The term can describe a physical checkout counter, a mobile checkout device or an online sales screen. In each case, the POS is where a business records what was sold, how much the customer paid and when the transaction occurred.</p>
    ...
    <p>For example, when a retailer sells one item, the POS system can record the payment and reduce the available stock for that product. The same transaction can then appear in daily sales reports without being entered again in a separate spreadsheet.</p>

    <h2 id="what-does-pos-stand-for">What does POS stand for?</h2>
    <p>POS stands for <strong>Point of Sale</strong>. “Point” refers to the place or step where the sale is completed. “Sale” refers to the transaction between the customer and business.</p>
    <ul>
    ...
    <h2 id="pos-hardware-and-software">What are the hardware and software parts of a POS system?</h2>
    ...
    <h2 id="benefits-of-a-pos-system">What are the benefits of a POS system?</h2>
    <ul>
    ...
    <h2 id="how-to-choose-a-pos-system">How do you choose the right POS system?</h2>
    <p>Choose a POS system by matching it to the transactions, products, staff and locations the business actually manages. A longer feature list is not automatically a better fit.</p>
    <ul>
    ...
    <p>A POS system combines software and compatible hardware to record sales, accept payments, issue receipts and manage information such as products, stock and customers.</p>
    ...
    <p>A multi-branch POS system can combine sales and stock information from several locations, but available controls and limits depend on the selected provider and plan.</p>
